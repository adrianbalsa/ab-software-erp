...
const AdminHeatmapMapClient = dynamic(
  ...
  { ssr: false, loading: () => <p className="text-sm text-zinc-600 dark:text-zinc-400">Preparando mapa de calor…</p> },
);

export default function AdminDashboardMapPage() {
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 px-4 py-8 text-zinc-900 dark:text-zinc-100">
