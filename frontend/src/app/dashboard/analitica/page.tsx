    ...
    <AppShell active="analitica">
      ...
      >
        <main className="flex min-h-0 flex-1 flex-col overflow-y-auto bg-zinc-50 dark:bg-zinc-950">
          <header className="flex h-16 shrink-0 items-center justify-between border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950/90 px-8 backdrop-blur-md">
            <div>
          ...
          <div className="w-full max-w-[100vw] flex-1 p-8">
            <Card className="bunker-card overflow-hidden border-zinc-200 dark:border-zinc-800">
              <CardHeader>
                <CardTitle className="text-zinc-900 dark:text-zinc-100">Rentabilidad y huella por ruta</CardTitle>
