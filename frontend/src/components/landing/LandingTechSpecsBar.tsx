...
export function LandingTechSpecsBar() {
  ...
  return (
    <motion.div
      ...
      className="border-y border-zinc-200/90 dark:border-zinc-800/90 bg-surface-base"
    >
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-center gap-x-8 gap-y-3 px-4 py-6 sm:px-6">
        {specs.map((label, i) => (
          <span key={label} className="flex items-center gap-2 text-xs font-medium uppercase tracking-widest text-zinc-600 dark:text-zinc-400">
            {i > 0 && (
