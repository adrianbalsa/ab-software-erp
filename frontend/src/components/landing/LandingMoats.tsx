          ...
          {capabilities.map((capability) => {
            ...
            return (
              <article
                ...
                className="rounded-3xl border border-zinc-200 bg-white/90 p-6 shadow-lg transition hover:border-zinc-300 hover:bg-zinc-100 dark:border-zinc-800 dark:bg-zinc-900/75 dark:hover:border-zinc-700 dark:hover:bg-zinc-900"
              >
                ...
                <p className="mt-3 text-sm leading-relaxed text-zinc-700 dark:text-zinc-300">{capability.description}</p>
              </article>
            );
          })}
        </div>
