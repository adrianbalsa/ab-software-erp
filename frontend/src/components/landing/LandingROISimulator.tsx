  ...
  return (
    <FadeInSection id="roi-simulator" className="scroll-mt-24 px-4 py-24 sm:px-6 sm:py-28">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="rounded-3xl border border-zinc-200 bg-surface-roi-gradient p-6 shadow-2xl shadow-zinc-400/20 dark:border-zinc-800 dark:shadow-black/40 sm:p-10">
            ...
            <div className="space-y-8">
              <div>
                ...
                <input
                  ...
                  className="w-full h-2 rounded-full appearance-none cursor-pointer accent-emerald-500 bg-zinc-300 dark:bg-zinc-700"
                />
                <p className="mt-1 text-xs text-zinc-700 dark:text-zinc-300">{l.fleetRangeHint}</p>
              </div>
              <div>
                <label className="flex justify-between text-sm font-medium text-zinc-700 dark:text-zinc-300 mb-2">
                ...
                <input
                  ...
                  className="w-full h-2 rounded-full appearance-none cursor-pointer accent-blue-500 bg-zinc-300 dark:bg-zinc-700"
                />
                <p className="mt-1 text-xs text-zinc-700 dark:text-zinc-300">{l.kmRangeHint}</p>
              </div>
            </div>

            <div className="space-y-4">
              <div className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-surface-panel p-4 dark:border-zinc-800">
              ...
              <div className="flex items-start gap-4 rounded-2xl border border-emerald-500/30 bg-emerald-500/5 p-4">
                ...
                <div>
                  <p className="text-xs font-medium uppercase tracking-wide text-zinc-700 dark:text-zinc-300">{l.economicSaving}</p>
                  <p className="text-2xl font-bold text-emerald-400 tabular-nums">
                    ...
                    <span className="text-sm font-normal text-zinc-700 dark:text-zinc-300"> {l.monthSuffix}</span>
                  </p>
                  <p className="text-xs text-zinc-700 dark:text-zinc-300 mt-1">{l.economicSavingHint}</p>
                </div>
              </div>
              <div className="flex items-start gap-4 rounded-2xl border border-zinc-200 bg-surface-panel p-4 dark:border-zinc-800">
                ...
                <div>
                  ...
                  <p className="text-xs text-zinc-700 dark:text-zinc-300 mt-1">{l.trackedEsgHint}</p>
                </div>
              </div>
            </div>
          </div>

          <div className="mt-8 flex flex-wrap items-center justify-center gap-3 rounded-2xl border border-zinc-200 bg-zinc-100/80 px-4 py-4 dark:border-zinc-800 dark:bg-zinc-900/50 sm:px-6">
            <Calculator className="h-5 w-5 text-blue-400 shrink-0" />
            <p className="text-center text-sm sm:text-base text-zinc-800 dark:text-zinc-200">
              {l.summaryPrefix}{" "}
