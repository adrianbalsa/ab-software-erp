...
export function LandingSocialProof() {
  ...
  return (
    <section
      ...
      className="border-y border-zinc-800/60 bg-gradient-to-b from-zinc-950/80 to-zinc-950 px-4 py-16 sm:px-6 sm:py-20"
    >
        ...
        <div className="mt-10 grid grid-cols-1 gap-6 sm:grid-cols-3">
          {l.stats.map((stat, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-zinc-800/90 bg-zinc-900/40 p-6"
            >
